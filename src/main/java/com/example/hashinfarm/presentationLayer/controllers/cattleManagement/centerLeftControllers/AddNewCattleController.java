...
import static com.example.hashinfarm.data.DAOs.CattleDAO.getCattleByID;
...
public class AddNewCattleController {
    ...
    private <T> T showSelectionDialog(List<T> items, Function<T, String> displayMapper) {
        return CattleDialogUtils.showSelectionDialog("Select Breed", "Select a breed from the list below", items, displayMapper);
    }

    private void showCattleSelectionDialog(Button buttonClicked, List<Cattle> cattleList) {
        Cattle selectedCattle = CattleDialogUtils.showSelectionDialog(
    ...
    private void gatherCattleInformationFromUI() {
        ...
        newCattle = CattleDialogUtils.createCattle(
