...
public class BreedingRecommendation {
    ...
    @FXML
    public CheckBox milkProductionPaneCkB, reproductivePerformancePaneCkB, diseaseResistancePaneCkB, muscleStructurePaneCkB,
            feedEfficiencyPaneCkB, dispositionAndTemperamentPaneCkB, adaptabilityToClimatePaneCkB, growthRatePaneCkB,
            grassFedAdaptabilityPaneCkB, hornedOrPolledPaneCkB, coatColorPaneCkB, calfVigorPaneCkB;

    private Map<String, List<CheckBox>> categoryToCheckBoxes = new HashMap<>();
    private ObservableList<String> selectedTraitsList = FXCollections.observableArrayList();
    @FXML
    ...
    private void initializeAccordion() {
        ...
        checkboxToCategory.forEach((checkbox, category) ->
    ...
    private void addTitledPane(String category) {
        ...
        if (category.equals("Horned Traits")) {
            ...
            for (int i = 0; i < hornedCheckBoxes.size(); i++) {
                ...
                hornedCheckBox.selectedProperty().addListener((observable, oldValue, newValue) -> {
            ...
            for (int i = 0; i < polledCheckBoxes.size(); i++) {
                ...
                // Add event listener to update ListView
                polledCheckBox.selectedProperty().addListener((observable, oldValue, newValue) -> {
    ...
    private List<CheckBox> createCheckBoxesForCategory(String category) {
        ...
        getTraitsForCategory(category).forEach(trait -> {
    ...
    private List<String> getTraitsForCategory(String category) {
        ...
        return switch (category) {
            case "Coat Color Traits" -> List.of(
                    "Solid Black", "Red with White Face", "Black and White Spotted", "Cream to White",
                    "Red and White or Yellow and White Patches", "Golden-Red or Yellow-Gold", "Red, White, or Roan",
                    "Light Gray to Almost Black", "Solid Red, Black, or Mix", "Multi-Colored with Long Curved Horns",
                    "Shaggy, Long Hair in Red, Black, Yellow, or Dun", "Solid Red, Heat-Resistant Breed",
                    "Black with a White Belt", "Silver to Dark Gray", "Pale Yellow to Light Gray, Double-Muscling",
                    "Solid Red, Dual-Purpose Breed", "White to Steel Gray", "Mahogany Red to Black",
                    "Red and White Spotted", "Solid Red, Angus and Brahman Cross", "Red and Sleek",
                    "Tricolor - Red, White, Dark Brown", "Various Colors, 'Beefy' Appearance",
                    "Fawn or Light Brown, High Butterfat", "Light to Dark Wheat-Colored", "Small-Sized with Brown Shades",
                    "Red and White like Holsteins", "Light to Dark Brown with Black Muzzle",
                    "Rich Red, Adaptable, Good Foraging"
            );

            case "Milk Production Traits" -> List.of(
            ...
            case "Reproductive Performance Traits" ->  List.of(
                    "Easy Calving", "Carries Calves to Term", "Gets Pregnant Easily",
                    "Stays Fertile for a Long Time", "Calves Born Without Problems",
                    "Reaches Maturity Early", "Efficient Breeding Over Time",
                    "Healthy and Productive Breeding", "Long-Lasting Breeding Capability",
                    "Quick Recovery After Giving Birth"
            );

            case "Disease Resistance Traits" -> List.of(
            ...
            case "Feed Efficiency Traits" -> List.of(
            ...
            case "Disposition and Temperament Traits" -> List.of(
                    "Calm and Easygoing", "Not Easily Agitated", "Friendly and Approachable",
                    "Gentle and Easy to Handle", "Patient with Handling Procedures",
                    "Good Mothering Instincts", "Easy to Work With", "Not Prone to Spookiness",
                    "Generally Relaxed Demeanor", "Gets Along Well with Other Cattle"
            );

            case "Growth Rate Traits" -> List.of(
            ...
            case "Calf Vigor Traits" ->  List.of(
            ...
            case "Grass-Fed Adaptability Traits" -> List.of(
                    ...
                    "Adapts Well to Diverse Pasture Types", "Utilizes Natural Grasses for Optimal Nutrition",
                    "Maintains Body Condition on Pasture Alone", "Shows Resilience in Changing Grass Availability",
                    "Flourishes with Minimal Supplemental Feed", "Exhibits a Preference for Grazing over Concentrates"
            );
            case "Horned Traits" ->  List.of(
            ...
            case "Adaptability to Climate Traits" -> List.of(
