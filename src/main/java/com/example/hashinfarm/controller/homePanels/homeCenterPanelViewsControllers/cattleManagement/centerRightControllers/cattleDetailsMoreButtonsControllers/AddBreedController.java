...
public class AddBreedController {
    ...
    @FXML
    private TableView<Breed> allBreedsTableView;

    @FXML
    private TextField breedNameTextField;

    @FXML
    private ComboBox<String> originComboBox;

    @FXML
    private CheckBox recognitionCheckBox;
    ...
    public void initialize() {
        ...
        allBreedsTableView.getColumns().addAll(breedIdColumn, breedNameColumn, originColumn, recognitionColumn, commentsColumn);
    ...
    private void loadBreedData() {
        try {
            ...
            e.printStackTrace();
            // Handle database errors or show error message to the user
        }
    }
