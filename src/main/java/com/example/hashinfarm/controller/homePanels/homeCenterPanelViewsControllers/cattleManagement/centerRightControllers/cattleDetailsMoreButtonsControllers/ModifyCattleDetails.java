...
public class ModifyCattleDetails {
    ...
    private void bindUIProperties(SelectedCattleManager cattleManager) {
        ...
        try {
            setCattleTag(damTagButton, selectedDam, cattleManager.getSelectedDamId(), cattleManager.getSelectedDamName());
            setCattleTag(sireTagButton, selectedSire, cattleManager.getSelectedSireId(), cattleManager.getSelectedSireName());
        } catch (SQLException e) {
            handleException(e);
        }
    }

    private void setCattleTag(Button button, Cattle selectedCattle, int selectedId, String selectedName) throws SQLException {
        if (selectedId != 0) {
            ...
            damNameLabel.setText(selectedName);
        }
    }
